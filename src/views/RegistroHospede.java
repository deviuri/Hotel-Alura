...
public class RegistroHospede extends JFrame {
    ...
    public void salvarHospede() {
        ...
        Hospede novoHospede = new Hospede(txtNome.getText(), txtSobrenome.getText(), java.sql.Date.valueOf(dataNascimento), txtNacionalidade.getSelectedItem().toString(), txtTelefone.getText(), Integer.parseInt(txtNreserva.getText()));
